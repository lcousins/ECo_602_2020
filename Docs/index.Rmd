...
The males are heavier than the females for all species.  Furthermore, irrespective of gender, the Gentoo penguins appear to be heavier than the others. In general, the Adelie appear to be slightly heavier than the Chinstrap, however there is some overlap becaise the weights are so similar.
